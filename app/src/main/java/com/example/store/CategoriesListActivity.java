    ...
    private void setViewPager() {
        mCategoryViewPager.setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int i) {
                ...
                switch (i){
                    case 0:
                        return CategoriesListFragment.newInstance(mCategories.get(0).getId());
                    case 1:
                        return CategoriesListFragment.newInstance(mCategories.get(1).getId());
                    case 2:
                        return CategoriesListFragment.newInstance(mCategories.get(2).getId());
                    case 3:
                        return CategoriesListFragment.newInstance(mCategories.get(3).getId());
                }
